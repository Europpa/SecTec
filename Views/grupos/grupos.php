...
<section class="main-container col-md-9">
  		...
  		<nav class="navbar navbar-default">
  			<div class="container-fluid">
    			<div class="navbar-header">
    				...
    				<a href="<?php echo BASE_URL . 'grupos'; ?>" class="btn btn-info navbar-btn active"><span class="glyphicon glyphicon-info-sign"></span> Ultimos grupos registrados</a>
    				<a href="<?php echo BASE_URL . 'grupos/listaGrupos'; ?>" class="btn btn-primary navbar-btn"><span class="glyphicon glyphicon-search"></span> Listar todos los grupos</a>
	...
	<table id="tbl-grupos" class="table table-striped table-bordered">
    <thead>
        <tr>
            <th>ID</th>
            <th>Grado</th>
...
<script src="<?php echo BASE_URL.'Views'.DS.'js'.DS.'jsgrupo.js';?>"></script>
